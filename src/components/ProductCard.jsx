...
export function ProductCard({ p, layout = "grid" }) {
  ...
  return (
    <div className={layout === "scroll" ? "col-card scroll-card col-12 col-md-6 col-lg-4" : "col-card col-12 col-md-6 col-lg-4"}>
      <div className="card h-100 shadow-sm border-0">
        <div className="position-relative img-wrapper">
          ...
          <button className="btn btn-light rounded-circle shadow-sm position-absolute top-0 end-0 m-2 fav-btn"
            ...
            <div className="controls-wrapper">
              {qty > 0 ? (
                <div className="quantity-box">
                  <button className="btn btn-sm btn-card-fill btn-minus" onClick={() => changeQty(-1)}>
                    <FontAwesomeIcon icon={faMinus} />
                  </button>
                  <span className="mx-2 small fw-bold text-white">{qty}</span>
                  <button className="btn btn-sm btn-card-fill btn-plus" onClick={() => changeQty(1)}>
